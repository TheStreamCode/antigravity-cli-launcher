...
exports.ANTIGRAVITY_INSTALL_PS1_URL = exports.ANTIGRAVITY_INSTALL_SH_URL = void 0;
exports.buildAntigravityInstallPromptMessage = buildAntigravityInstallPromptMessage;
exports.buildAntigravityInstallPromptCommand = buildAntigravityInstallPromptCommand;
exports.getDefaultAntigravityBinDir = getDefaultAntigravityBinDir;
exports.getDefaultAntigravityExecutablePath = getDefaultAntigravityExecutablePath;
...
exports.buildAntigravityInstallPromptScript = buildAntigravityInstallPromptScript;
const path = __importStar(require("node:path"));
const ANTIGRAVITY_INSTALL_SH_URL = 'https://antigravity.google/cli/install.sh';
exports.ANTIGRAVITY_INSTALL_SH_URL = ANTIGRAVITY_INSTALL_SH_URL;
const ANTIGRAVITY_INSTALL_PS1_URL = 'https://antigravity.google/cli/install.ps1';
exports.ANTIGRAVITY_INSTALL_PS1_URL = ANTIGRAVITY_INSTALL_PS1_URL;
...
function getDefaultAntigravityExecutablePath(platform = process.platform, env = process.env, homedir = '') {
...
function buildAntigravityInstallPromptScript(shellInstallUrl = ANTIGRAVITY_INSTALL_SH_URL, windowsInstallUrl = ANTIGRAVITY_INSTALL_PS1_URL) {
